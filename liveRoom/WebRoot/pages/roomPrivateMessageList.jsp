...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>js/roomprivatemessage.js"></script>
  </head>
  
  <body onload="roomPrivateMessageList()">
  	...
  	<div style="text-align:ceter;height:90%;position:relative;">
  		<div>
	    	<table id="roomPrivateMessageTable" class="main_table" border="1">
		    	<thead>
		    		<tr>
