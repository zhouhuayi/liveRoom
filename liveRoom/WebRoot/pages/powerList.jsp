...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>js/power.js"></script>
  </head>
  
  <body onload="PowerList()">
  	...
  	<div style="height: 5%;">
	  	<div style="margin-top: 5px;margin-bottom: 5px;padding-left: 5px;width: 100%">
			...
			<button style="background-color: #4169E1;padding: 5px 15px 5px 15px;cursor: pointer;" 
  				onclick="openPowerAddPage()">
  	...
  	<div style="text-align:ceter;height:90%;position:relative;">
  		<div>
	    	<table id="powerTable" class="main_table" border="1">
		    	<thead>
		    		<tr>
