...
<html>
  ...
  <body>
	  <form action="updateAdvertise.do" method="post" enctype="multipart/form-data">
	  	<input type="hidden" name="id" value="${advertise.id}"> 
	  	<input type="hidden" name="photoPath" value="${advertise.images}"> 
	  	...
	  	<div style="padding: 10px 10px 10px 10px;width: 100%;">
				...
				<div style="text-align: left;float: left;margin-left: 3px;">
					<input type="text" name="title" id="title" style="height:30px;width:200px;"value="${advertise.title}">
				</div>
			</div>
	  	...
	  	<div style="text-align: center;width: 80%">
			<div style="padding: 10px 10px 10px 10px;float:left;width: 100%;">
				...
				<div style="text-align: left;float: left;margin-left: 3px;">
					...
					value="${advertise.images}" readonly="readonly">
			...
			<div style="padding: 10px 10px 10px 10px;float:left;width: 100%;">
				...
				<div style="text-align: left;float: left;margin-left: 3px;">
					<div style="border: 1px solid;height:100;width:200">
						<span id="img" ><img src="${advertise.images}" width="200" height="100"></span>
					</div>
				</div>
			</div>
			...
			<div style="padding: 10px 10px 10px 10px;width: 100%;">
				...
				<div style="text-align: left;float: left;margin-left: 3px;">
					<input type="text" name="url" value="${advertise.url}" id="url" style="height:30px;width:200px;">
				</div>
			</div>
