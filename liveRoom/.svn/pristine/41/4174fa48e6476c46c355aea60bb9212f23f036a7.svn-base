...
public interface FriendPrivateChatService {
	/**
	 * 查询分页好友私聊列表
	 * 
	 * @author 李琼雅
	 ...
	 * @return
	 */
	public Map<String, Object> FriendChatList(int pageNum, int pageSize,Map<String, Object> params, String whereSql, Map<String, Object> orderBy);
	/**
	 * 修改单条状态
	 * 
	 * @author 李琼雅
